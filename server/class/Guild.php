...
use Schema\GuildDungeonBattle as DBGuildDungeonBattle;
...
class Guild extends DBGuild implements JsonSerializable{
    ...
    private function setDungeonAsFinished(){
        $this->finished_dungeon = $this->pending_attack;
        $this->pending_guild_dungeon_battle_attack_id = 0;
        $this->pending_dungeon = null;
    }
