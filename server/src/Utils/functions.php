...
function randomSidekickSkills() {
    /*
    ALL AVAILABLE SKILLS
    $first = [1, 2, 3, 4, 5, 22, 24, 28, 31, 33, 40];
    $second = [6, 7, 8, 9, 10, 11, 12, 23, 25, 27, 29, 34];
    $third = [15, 16, 17, 18, 20, 21, 26, 30, 32, 35, 36, 38, 39];
    */
    ...
    $arr[] = $first[mt_rand(0, count($first) - 1)];
    $arr[] = $second[mt_rand(0, count($second) - 1)];
    $arr[] = $third[mt_rand(0, count($third) - 1)];
    return $arr;
}
