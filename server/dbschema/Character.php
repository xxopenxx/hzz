...
class Character extends Record implements JsonSerializable{
	...
	public $unread_mass_system_messages = 0;
    public $ts_guild_joined = 0;
	public $received_sidekick = '';
    ...
    protected static $_FIELDS = [
		...
		"active_quest_booster_id" => "booster_quest0",
		"ts_active_quest_boost_expires" => -62169987600,
		"active_stats_booster_id" => "booster_stats0",
		"ts_active_stats_boost_expires" => -62169987600,
		"active_work_booster_id" => "booster_work0",
		"ts_active_work_boost_expires" => 1563871617,
		"ts_active_sense_boost_expires" => -62169987600,
		...
		"appearance_hair_type" => 6,
		"appearance_head_type" => 1,
		"appearance_eyes_type" => 11,
		"appearance_eyebrows_type" => 10,
		"appearance_nose_type" => 11,
		"appearance_mouth_type" => 5,
		"appearance_facial_hair_type" => 1,
		"appearance_decoration_type" => 3,
		"show_mask" => true,
		"tutorial_flags" => "",
		"guild_id" => 0,
		"guild_rank" => 0,
