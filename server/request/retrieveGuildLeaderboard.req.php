...
class retrieveGuildLeaderboard{
    public function __request($player){
        ...
        g.`emblem_background_shape` as ebs, g.`emblem_background_color` as ebc, g.`emblem_background_border_color` as ebbc, g.`emblem_icon_shape` as eis, g.`emblem_icon_color` as eic, g.`emblem_icon_size` as eiz, g.`artifact_ids` as ga, COALESCE(gb.id,0) as gbd, '0' as v, 'true' as am, 'true' as ao, 'pl_PL' as l";
